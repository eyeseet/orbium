(function (orbium, undefined) {
  orbium.Menu = function () {
    ...
    this.setupMouseEvents = function () {
      ...
      orbium.Util.attachListener(about, "mousedown", function() {orbium.menu.about();});
      ...
      orbium.Util.attachListener(support, "mousedown", function() {orbium.menu.support();});
      orbium.Util.attachListener(credits, "mousedown", function() {orbium.menu.credits();});
      orbium.Util.attachListener(abob, "mousedown", function() {orbium.menu.abob();});
      ...
      orbium.Util.attachListener(editoron, "mousedown", function() {orbium.menu.editoron();});
      orbium.Util.attachListener(perfon, "mousedown", function() {orbium.menu.perfon();});
      orbium.Util.attachListener(connecton, "mousedown", function() {orbium.menu.connecton();});

      orbium.Util.attachListener(logo, "mousedown", function() {orbium.menu.logo();});

      orbium.Util.attachListener(credb, "mousedown", function() {orbium.menu.credb();});
      ...
      orbium.Util.attachListener(contact, "mousedown", function() {orbium.menu.contact();});
      orbium.Util.attachListener(gfx, "mousedown", function() {orbium.menu.gfx();});
